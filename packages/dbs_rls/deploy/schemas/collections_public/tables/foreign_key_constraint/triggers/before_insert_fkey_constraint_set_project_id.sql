-- Deploy schemas/collections_public/tables/foreign_key_constraint/triggers/before_insert_fkey_constraint_set_project_id to pg
...
CREATE FUNCTION collections_private.tg_before_insert_fkey_constraint_set_project_id()
RETURNS TRIGGER AS $$
DECLARE
  proj_id uuid;
BEGIN
