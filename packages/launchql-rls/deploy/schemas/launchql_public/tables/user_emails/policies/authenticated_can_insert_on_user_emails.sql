-- Deploy: schemas/launchql_public/tables/user_emails/policies/authenticated_can_insert_on_user_emails to pg
...
-- requires: schemas/launchql_public/tables/user_emails/policies/authenticated_can_select_on_user_emails
