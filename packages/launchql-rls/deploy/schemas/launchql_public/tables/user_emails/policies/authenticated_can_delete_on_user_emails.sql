-- Deploy: schemas/launchql_public/tables/user_emails/policies/authenticated_can_delete_on_user_emails to pg
...
-- requires: schemas/launchql_public/tables/user_emails/policies/authenticated_can_update_on_user_emails
