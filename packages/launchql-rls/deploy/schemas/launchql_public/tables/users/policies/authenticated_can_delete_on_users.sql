-- Deploy: schemas/launchql_public/tables/users/policies/authenticated_can_delete_on_users to pg
...
-- requires: schemas/launchql_public/tables/users/policies/authenticated_can_update_on_users
