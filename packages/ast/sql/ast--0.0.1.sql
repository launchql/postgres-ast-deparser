...
CREATE FUNCTION ast_helpers.create_policy ( name text, vschema text, vtable text, vrole text, qual jsonb, cmd text, permissive boolean ) RETURNS jsonb AS $EOFCODE$
DECLARE
  ast jsonb;
BEGIN
