...
CREATE FUNCTION ast_helpers.denormalized_fields_trigger_body ( v_schema_name text, v_table_name text, v_parent_key text, v_ref_key text, v_sel_fields text[], v_into_fields text[] ) RETURNS text AS $EOFCODE$
DECLARE
  ast_expr jsonb;
  body text;
  sel_fields jsonb[];
