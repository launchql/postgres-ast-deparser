...
CREATE FUNCTION ast.alias ( v_type text DEFAULT NULL, v_aliasname text DEFAULT NULL, v_colnames jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_var ( v_type text DEFAULT NULL, v_catalogname text DEFAULT NULL, v_schemaname text DEFAULT NULL, v_relname text DEFAULT NULL, v_inh boolean DEFAULT NULL, v_relpersistence text DEFAULT NULL, v_alias jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.table_func ( v_type text DEFAULT NULL, v_ns_uris jsonb DEFAULT NULL, v_ns_names jsonb DEFAULT NULL, v_docexpr jsonb DEFAULT NULL, v_rowexpr jsonb DEFAULT NULL, v_colnames jsonb DEFAULT NULL, v_coltypes jsonb DEFAULT NULL, v_coltypmods jsonb DEFAULT NULL, v_colcollations jsonb DEFAULT NULL, v_colexprs jsonb DEFAULT NULL, v_coldefexprs jsonb DEFAULT NULL, v_notnulls jsonb DEFAULT NULL, v_ordinalitycol int DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.into_clause ( v_type text DEFAULT NULL, v_rel jsonb DEFAULT NULL, v_colnames jsonb DEFAULT NULL, v_accessmethod text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_oncommit text DEFAULT NULL, v_tablespacename text DEFAULT NULL, v_viewquery jsonb DEFAULT NULL, v_skipdata boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.expr ( v_type text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.const ( v_xpr jsonb DEFAULT NULL, v_consttype jsonb DEFAULT NULL, v_consttypmod int DEFAULT NULL, v_constcollid jsonb DEFAULT NULL, v_constlen int DEFAULT NULL, v_constvalue jsonb DEFAULT NULL, v_constisnull boolean DEFAULT NULL, v_constbyval boolean DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.param ( v_xpr jsonb DEFAULT NULL, v_paramkind text DEFAULT NULL, v_paramid int DEFAULT NULL, v_paramtype jsonb DEFAULT NULL, v_paramtypmod int DEFAULT NULL, v_paramcollid jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.grouping_func ( v_xpr jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_refs jsonb DEFAULT NULL, v_cols jsonb DEFAULT NULL, v_agglevelsup jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.func_expr ( v_xpr jsonb DEFAULT NULL, v_funcid jsonb DEFAULT NULL, v_funcresulttype jsonb DEFAULT NULL, v_funcretset boolean DEFAULT NULL, v_funcvariadic boolean DEFAULT NULL, v_funcformat text DEFAULT NULL, v_funccollid jsonb DEFAULT NULL, v_inputcollid jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.named_arg_expr ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_name text DEFAULT NULL, v_argnumber int DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.op_expr ( v_xpr jsonb DEFAULT NULL, v_opno jsonb DEFAULT NULL, v_opfuncid jsonb DEFAULT NULL, v_opresulttype jsonb DEFAULT NULL, v_opretset boolean DEFAULT NULL, v_opcollid jsonb DEFAULT NULL, v_inputcollid jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.scalar_array_op_expr ( v_xpr jsonb DEFAULT NULL, v_opno jsonb DEFAULT NULL, v_opfuncid jsonb DEFAULT NULL, v_useor boolean DEFAULT NULL, v_inputcollid jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.bool_expr ( v_xpr jsonb DEFAULT NULL, v_boolop text DEFAULT NULL, v_args jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.sub_link ( v_xpr jsonb DEFAULT NULL, v_sublinktype text DEFAULT NULL, v_sublinkid int DEFAULT NULL, v_testexpr jsonb DEFAULT NULL, v_opername jsonb DEFAULT NULL, v_subselect jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.relabel_type ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_resulttype jsonb DEFAULT NULL, v_resulttypmod int DEFAULT NULL, v_resultcollid jsonb DEFAULT NULL, v_relabelformat text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.coerce_via_io ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_resulttype jsonb DEFAULT NULL, v_resultcollid jsonb DEFAULT NULL, v_coerceformat text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.array_coerce_expr ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_elemexpr jsonb DEFAULT NULL, v_resulttype jsonb DEFAULT NULL, v_resulttypmod int DEFAULT NULL, v_resultcollid jsonb DEFAULT NULL, v_coerceformat text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.convert_rowtype_expr ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_resulttype jsonb DEFAULT NULL, v_convertformat text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.collate_expr ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_colloid jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.case_expr ( v_xpr jsonb DEFAULT NULL, v_casetype jsonb DEFAULT NULL, v_casecollid jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_defresult jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.case_when ( v_xpr jsonb DEFAULT NULL, v_expr jsonb DEFAULT NULL, v_result jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.array_expr ( v_xpr jsonb DEFAULT NULL, v_array_typeid jsonb DEFAULT NULL, v_array_collid jsonb DEFAULT NULL, v_element_typeid jsonb DEFAULT NULL, v_elements jsonb DEFAULT NULL, v_multidims boolean DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.row_expr ( v_xpr jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_row_typeid jsonb DEFAULT NULL, v_row_format text DEFAULT NULL, v_colnames jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.coalesce_expr ( v_xpr jsonb DEFAULT NULL, v_coalescetype jsonb DEFAULT NULL, v_coalescecollid jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.min_max_expr ( v_xpr jsonb DEFAULT NULL, v_minmaxtype jsonb DEFAULT NULL, v_minmaxcollid jsonb DEFAULT NULL, v_inputcollid jsonb DEFAULT NULL, v_op text DEFAULT NULL, v_args jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.sql_value_function ( v_xpr jsonb DEFAULT NULL, v_op text DEFAULT NULL, v_type jsonb DEFAULT NULL, v_typmod int DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.xml_expr ( v_xpr jsonb DEFAULT NULL, v_op text DEFAULT NULL, v_name text DEFAULT NULL, v_named_args jsonb DEFAULT NULL, v_arg_names jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_xmloption text DEFAULT NULL, v_type jsonb DEFAULT NULL, v_typmod int DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.null_test ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_nulltesttype text DEFAULT NULL, v_argisrow boolean DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.boolean_test ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_booltesttype text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.coerce_to_domain ( v_xpr jsonb DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_resulttype jsonb DEFAULT NULL, v_resulttypmod int DEFAULT NULL, v_resultcollid jsonb DEFAULT NULL, v_coercionformat text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.coerce_to_domain_value ( v_xpr jsonb DEFAULT NULL, v_typeid jsonb DEFAULT NULL, v_typemod int DEFAULT NULL, v_collation jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.set_to_default ( v_xpr jsonb DEFAULT NULL, v_typeid jsonb DEFAULT NULL, v_typemod int DEFAULT NULL, v_collation jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_tbl_ref ( v_type text DEFAULT NULL, v_rtindex int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.join_expr ( v_type text DEFAULT NULL, v_jointype text DEFAULT NULL, v_isnatural boolean DEFAULT NULL, v_larg jsonb DEFAULT NULL, v_rarg jsonb DEFAULT NULL, v_usingclause jsonb DEFAULT NULL, v_quals jsonb DEFAULT NULL, v_alias jsonb DEFAULT NULL, v_rtindex int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.from_expr ( v_type text DEFAULT NULL, v_fromlist jsonb DEFAULT NULL, v_quals jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.on_conflict_expr ( v_type text DEFAULT NULL, v_action text DEFAULT NULL, v_arbiterelems jsonb DEFAULT NULL, v_arbiterwhere jsonb DEFAULT NULL, v_constraint jsonb DEFAULT NULL, v_onconflictset jsonb DEFAULT NULL, v_onconflictwhere jsonb DEFAULT NULL, v_exclrelindex int DEFAULT NULL, v_exclreltlist jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.type_name ( v_type text DEFAULT NULL, v_names jsonb DEFAULT NULL, v_typeoid jsonb DEFAULT NULL, v_setof boolean DEFAULT NULL, v_pct_type boolean DEFAULT NULL, v_typmods jsonb DEFAULT NULL, v_typemod int DEFAULT NULL, v_arraybounds jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.column_ref ( v_type text DEFAULT NULL, v_fields jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.param_ref ( v_type text DEFAULT NULL, v_number int DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.a_expr ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_name jsonb DEFAULT NULL, v_lexpr jsonb DEFAULT NULL, v_rexpr jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.a_const ( v_type text DEFAULT NULL, v_val jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.type_cast ( v_type text DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.collate_clause ( v_type text DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_collname jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.role_spec ( v_type text DEFAULT NULL, v_roletype text DEFAULT NULL, v_rolename text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.func_call ( v_type text DEFAULT NULL, v_funcname jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_agg_order jsonb DEFAULT NULL, v_agg_filter jsonb DEFAULT NULL, v_agg_within_group boolean DEFAULT NULL, v_agg_star boolean DEFAULT NULL, v_agg_distinct boolean DEFAULT NULL, v_func_variadic boolean DEFAULT NULL, v_over jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.a_star ( v_type text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.a_indices ( v_type text DEFAULT NULL, v_is_slice boolean DEFAULT NULL, v_lidx jsonb DEFAULT NULL, v_uidx jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.a_indirection ( v_type text DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_indirection jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.a_array_expr ( v_type text DEFAULT NULL, v_elements jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.res_target ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_indirection jsonb DEFAULT NULL, v_val jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.multi_assign_ref ( v_type text DEFAULT NULL, v_source jsonb DEFAULT NULL, v_colno int DEFAULT NULL, v_ncolumns int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.sort_by ( v_type text DEFAULT NULL, v_node jsonb DEFAULT NULL, v_sortby_dir text DEFAULT NULL, v_sortby_nulls text DEFAULT NULL, v_useop jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.window_def ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_refname text DEFAULT NULL, v_partitionclause jsonb DEFAULT NULL, v_orderclause jsonb DEFAULT NULL, v_frameoptions int DEFAULT NULL, v_startoffset jsonb DEFAULT NULL, v_endoffset jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_subselect ( v_type text DEFAULT NULL, v_lateral boolean DEFAULT NULL, v_subquery jsonb DEFAULT NULL, v_alias jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_function ( v_type text DEFAULT NULL, v_lateral boolean DEFAULT NULL, v_ordinality boolean DEFAULT NULL, v_is_rowsfrom boolean DEFAULT NULL, v_functions jsonb DEFAULT NULL, v_alias jsonb DEFAULT NULL, v_coldeflist jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_table_func ( v_type text DEFAULT NULL, v_lateral boolean DEFAULT NULL, v_docexpr jsonb DEFAULT NULL, v_rowexpr jsonb DEFAULT NULL, v_namespaces jsonb DEFAULT NULL, v_columns jsonb DEFAULT NULL, v_alias jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_table_func_col ( v_type text DEFAULT NULL, v_colname text DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_for_ordinality boolean DEFAULT NULL, v_is_not_null boolean DEFAULT NULL, v_colexpr jsonb DEFAULT NULL, v_coldefexpr jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_table_sample ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_method jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_repeatable jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.column_def ( v_type text DEFAULT NULL, v_colname text DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_inhcount int DEFAULT NULL, v_is_local boolean DEFAULT NULL, v_is_not_null boolean DEFAULT NULL, v_is_from_type boolean DEFAULT NULL, v_storage text DEFAULT NULL, v_raw_default jsonb DEFAULT NULL, v_cooked_default jsonb DEFAULT NULL, v_identity text DEFAULT NULL, v_identitysequence jsonb DEFAULT NULL, v_generated text DEFAULT NULL, v_collclause jsonb DEFAULT NULL, v_colloid jsonb DEFAULT NULL, v_constraints jsonb DEFAULT NULL, v_fdwoptions jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.table_like_clause ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.index_elem ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_expr jsonb DEFAULT NULL, v_indexcolname text DEFAULT NULL, v_collation jsonb DEFAULT NULL, v_opclass jsonb DEFAULT NULL, v_opclassopts jsonb DEFAULT NULL, v_ordering text DEFAULT NULL, v_nulls_ordering text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.def_elem ( v_type text DEFAULT NULL, v_defnamespace text DEFAULT NULL, v_defname text DEFAULT NULL, v_arg jsonb DEFAULT NULL, v_defaction text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.locking_clause ( v_type text DEFAULT NULL, v_lockedrels jsonb DEFAULT NULL, v_strength text DEFAULT NULL, v_waitpolicy text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.xml_serialize ( v_type text DEFAULT NULL, v_xmloption text DEFAULT NULL, v_expr jsonb DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.partition_elem ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_expr jsonb DEFAULT NULL, v_collation jsonb DEFAULT NULL, v_opclass jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.partition_spec ( v_type text DEFAULT NULL, v_strategy text DEFAULT NULL, v_partparams jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.partition_bound_spec ( v_type text DEFAULT NULL, v_strategy text DEFAULT NULL, v_is_default boolean DEFAULT NULL, v_modulus int DEFAULT NULL, v_remainder int DEFAULT NULL, v_listdatums jsonb DEFAULT NULL, v_lowerdatums jsonb DEFAULT NULL, v_upperdatums jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.partition_range_datum ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_value jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.partition_cmd ( v_type text DEFAULT NULL, v_name jsonb DEFAULT NULL, v_bound jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.range_tbl_function ( v_type text DEFAULT NULL, v_funcexpr jsonb DEFAULT NULL, v_funccolcount int DEFAULT NULL, v_funccolnames jsonb DEFAULT NULL, v_funccoltypes jsonb DEFAULT NULL, v_funccoltypmods jsonb DEFAULT NULL, v_funccolcollations jsonb DEFAULT NULL, v_funcparams jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.table_sample_clause ( v_type text DEFAULT NULL, v_tsmhandler jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_repeatable jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.with_check_option ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_relname text DEFAULT NULL, v_polname text DEFAULT NULL, v_qual jsonb DEFAULT NULL, v_cascaded boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.sort_group_clause ( v_type text DEFAULT NULL, v_tlesortgroupref jsonb DEFAULT NULL, v_eqop jsonb DEFAULT NULL, v_sortop jsonb DEFAULT NULL, v_nulls_first boolean DEFAULT NULL, v_hashable boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.grouping_set ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_content jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.window_clause ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_refname text DEFAULT NULL, v_partitionclause jsonb DEFAULT NULL, v_orderclause jsonb DEFAULT NULL, v_frameoptions int DEFAULT NULL, v_startoffset jsonb DEFAULT NULL, v_endoffset jsonb DEFAULT NULL, v_startinrangefunc jsonb DEFAULT NULL, v_endinrangefunc jsonb DEFAULT NULL, v_inrangecoll jsonb DEFAULT NULL, v_inrangeasc boolean DEFAULT NULL, v_inrangenullsfirst boolean DEFAULT NULL, v_winref jsonb DEFAULT NULL, v_copiedorder boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.row_mark_clause ( v_type text DEFAULT NULL, v_rti jsonb DEFAULT NULL, v_strength text DEFAULT NULL, v_waitpolicy text DEFAULT NULL, v_pusheddown boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.with_clause ( v_type text DEFAULT NULL, v_ctes jsonb DEFAULT NULL, v_recursive boolean DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.infer_clause ( v_type text DEFAULT NULL, v_indexelems jsonb DEFAULT NULL, v_whereclause jsonb DEFAULT NULL, v_conname text DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.on_conflict_clause ( v_type text DEFAULT NULL, v_action text DEFAULT NULL, v_infer jsonb DEFAULT NULL, v_targetlist jsonb DEFAULT NULL, v_whereclause jsonb DEFAULT NULL, v_location int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.common_table_expr ( v_type text DEFAULT NULL, v_ctename text DEFAULT NULL, v_aliascolnames jsonb DEFAULT NULL, v_ctematerialized text DEFAULT NULL, v_ctequery jsonb DEFAULT NULL, v_location int DEFAULT NULL, v_cterecursive boolean DEFAULT NULL, v_cterefcount int DEFAULT NULL, v_ctecolnames jsonb DEFAULT NULL, v_ctecoltypes jsonb DEFAULT NULL, v_ctecoltypmods jsonb DEFAULT NULL, v_ctecolcollations jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.trigger_transition ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_isnew boolean DEFAULT NULL, v_istable boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.raw_stmt ( v_type text DEFAULT NULL, v_stmt jsonb DEFAULT NULL, v_stmt_location int DEFAULT NULL, v_stmt_len int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.insert_stmt ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_cols jsonb DEFAULT NULL, v_selectstmt jsonb DEFAULT NULL, v_onconflictclause jsonb DEFAULT NULL, v_returninglist jsonb DEFAULT NULL, v_withclause jsonb DEFAULT NULL, v_override text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.delete_stmt ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_usingclause jsonb DEFAULT NULL, v_whereclause jsonb DEFAULT NULL, v_returninglist jsonb DEFAULT NULL, v_withclause jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.update_stmt ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_targetlist jsonb DEFAULT NULL, v_whereclause jsonb DEFAULT NULL, v_fromclause jsonb DEFAULT NULL, v_returninglist jsonb DEFAULT NULL, v_withclause jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.set_operation_stmt ( v_type text DEFAULT NULL, v_op text DEFAULT NULL, v_all boolean DEFAULT NULL, v_larg jsonb DEFAULT NULL, v_rarg jsonb DEFAULT NULL, v_coltypes jsonb DEFAULT NULL, v_coltypmods jsonb DEFAULT NULL, v_colcollations jsonb DEFAULT NULL, v_groupclauses jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_schema_stmt ( v_type text DEFAULT NULL, v_schemaname text DEFAULT NULL, v_authrole jsonb DEFAULT NULL, v_schemaelts jsonb DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_table_stmt ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_cmds jsonb DEFAULT NULL, v_relkind text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.replica_identity_stmt ( v_type text DEFAULT NULL, v_identity_type text DEFAULT NULL, v_name text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_table_cmd ( v_type text DEFAULT NULL, v_subtype text DEFAULT NULL, v_name text DEFAULT NULL, v_num int DEFAULT NULL, v_newowner jsonb DEFAULT NULL, v_def jsonb DEFAULT NULL, v_behavior text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_collation_stmt ( v_type text DEFAULT NULL, v_collname jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_domain_stmt ( v_type text DEFAULT NULL, v_subtype text DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_name text DEFAULT NULL, v_def jsonb DEFAULT NULL, v_behavior text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.grant_stmt ( v_type text DEFAULT NULL, v_is_grant boolean DEFAULT NULL, v_targtype text DEFAULT NULL, v_objtype text DEFAULT NULL, v_objects jsonb DEFAULT NULL, v_privileges jsonb DEFAULT NULL, v_grantees jsonb DEFAULT NULL, v_grant_option boolean DEFAULT NULL, v_behavior text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.object_with_args ( v_type text DEFAULT NULL, v_objname jsonb DEFAULT NULL, v_objargs jsonb DEFAULT NULL, v_args_unspecified boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.access_priv ( v_type text DEFAULT NULL, v_priv_name text DEFAULT NULL, v_cols jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.grant_role_stmt ( v_type text DEFAULT NULL, v_granted_roles jsonb DEFAULT NULL, v_grantee_roles jsonb DEFAULT NULL, v_is_grant boolean DEFAULT NULL, v_admin_opt boolean DEFAULT NULL, v_grantor jsonb DEFAULT NULL, v_behavior text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_default_privileges_stmt ( v_type text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_action jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.copy_stmt ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_query jsonb DEFAULT NULL, v_attlist jsonb DEFAULT NULL, v_is_from boolean DEFAULT NULL, v_is_program boolean DEFAULT NULL, v_filename text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_whereclause jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.variable_set_stmt ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_name text DEFAULT NULL, v_args jsonb DEFAULT NULL, v_is_local boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.variable_show_stmt ( v_type text DEFAULT NULL, v_name text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_table_space_stmt ( v_type text DEFAULT NULL, v_tablespacename text DEFAULT NULL, v_owner jsonb DEFAULT NULL, v_location text DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.drop_table_space_stmt ( v_type text DEFAULT NULL, v_tablespacename text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_table_space_options_stmt ( v_type text DEFAULT NULL, v_tablespacename text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_isreset boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_table_move_all_stmt ( v_type text DEFAULT NULL, v_orig_tablespacename text DEFAULT NULL, v_objtype text DEFAULT NULL, v_roles jsonb DEFAULT NULL, v_new_tablespacename text DEFAULT NULL, v_nowait boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_extension_stmt ( v_type text DEFAULT NULL, v_extname text DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_extension_stmt ( v_type text DEFAULT NULL, v_extname text DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_extension_contents_stmt ( v_type text DEFAULT NULL, v_extname text DEFAULT NULL, v_action int DEFAULT NULL, v_objtype text DEFAULT NULL, v_object jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_fdw_stmt ( v_type text DEFAULT NULL, v_fdwname text DEFAULT NULL, v_func_options jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_fdw_stmt ( v_type text DEFAULT NULL, v_fdwname text DEFAULT NULL, v_func_options jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_foreign_server_stmt ( v_type text DEFAULT NULL, v_servername text DEFAULT NULL, v_servertype text DEFAULT NULL, v_version text DEFAULT NULL, v_fdwname text DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_foreign_server_stmt ( v_type text DEFAULT NULL, v_servername text DEFAULT NULL, v_version text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_has_version boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_user_mapping_stmt ( v_type text DEFAULT NULL, v_user jsonb DEFAULT NULL, v_servername text DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_user_mapping_stmt ( v_type text DEFAULT NULL, v_user jsonb DEFAULT NULL, v_servername text DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.drop_user_mapping_stmt ( v_type text DEFAULT NULL, v_user jsonb DEFAULT NULL, v_servername text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.import_foreign_schema_stmt ( v_type text DEFAULT NULL, v_server_name text DEFAULT NULL, v_remote_schema text DEFAULT NULL, v_local_schema text DEFAULT NULL, v_list_type text DEFAULT NULL, v_table_list jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_policy_stmt ( v_type text DEFAULT NULL, v_policy_name text DEFAULT NULL, v_table jsonb DEFAULT NULL, v_cmd_name text DEFAULT NULL, v_permissive boolean DEFAULT NULL, v_roles jsonb DEFAULT NULL, v_qual jsonb DEFAULT NULL, v_with_check jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_policy_stmt ( v_type text DEFAULT NULL, v_policy_name text DEFAULT NULL, v_table jsonb DEFAULT NULL, v_roles jsonb DEFAULT NULL, v_qual jsonb DEFAULT NULL, v_with_check jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_am_stmt ( v_type text DEFAULT NULL, v_amname text DEFAULT NULL, v_handler_name jsonb DEFAULT NULL, v_amtype text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_event_trig_stmt ( v_type text DEFAULT NULL, v_trigname text DEFAULT NULL, v_eventname text DEFAULT NULL, v_whenclause jsonb DEFAULT NULL, v_funcname jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_event_trig_stmt ( v_type text DEFAULT NULL, v_trigname text DEFAULT NULL, v_tgenabled text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_p_lang_stmt ( v_type text DEFAULT NULL, v_replace boolean DEFAULT NULL, v_plname text DEFAULT NULL, v_plhandler jsonb DEFAULT NULL, v_plinline jsonb DEFAULT NULL, v_plvalidator jsonb DEFAULT NULL, v_pltrusted boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_role_stmt ( v_type text DEFAULT NULL, v_stmt_type text DEFAULT NULL, v_role text DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_role_stmt ( v_type text DEFAULT NULL, v_role jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL, v_action int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_role_set_stmt ( v_type text DEFAULT NULL, v_role jsonb DEFAULT NULL, v_database text DEFAULT NULL, v_setstmt jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.drop_role_stmt ( v_type text DEFAULT NULL, v_roles jsonb DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_seq_stmt ( v_type text DEFAULT NULL, v_sequence jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL, v_ownerid jsonb DEFAULT NULL, v_for_identity boolean DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_seq_stmt ( v_type text DEFAULT NULL, v_sequence jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL, v_for_identity boolean DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.define_stmt ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_oldstyle boolean DEFAULT NULL, v_defnames jsonb DEFAULT NULL, v_args jsonb DEFAULT NULL, v_definition jsonb DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL, v_replace boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_domain_stmt ( v_type text DEFAULT NULL, v_domainname jsonb DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_collclause jsonb DEFAULT NULL, v_constraints jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_op_class_stmt ( v_type text DEFAULT NULL, v_opclassname jsonb DEFAULT NULL, v_opfamilyname jsonb DEFAULT NULL, v_amname text DEFAULT NULL, v_datatype jsonb DEFAULT NULL, v_items jsonb DEFAULT NULL, v_isdefault boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_op_class_item ( v_type text DEFAULT NULL, v_itemtype int DEFAULT NULL, v_name jsonb DEFAULT NULL, v_number int DEFAULT NULL, v_order_family jsonb DEFAULT NULL, v_class_args jsonb DEFAULT NULL, v_storedtype jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_op_family_stmt ( v_type text DEFAULT NULL, v_opfamilyname jsonb DEFAULT NULL, v_amname text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_op_family_stmt ( v_type text DEFAULT NULL, v_opfamilyname jsonb DEFAULT NULL, v_amname text DEFAULT NULL, v_isdrop boolean DEFAULT NULL, v_items jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.drop_stmt ( v_type text DEFAULT NULL, v_objects jsonb DEFAULT NULL, v_removetype text DEFAULT NULL, v_behavior text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL, v_concurrent boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.truncate_stmt ( v_type text DEFAULT NULL, v_relations jsonb DEFAULT NULL, v_restart_seqs boolean DEFAULT NULL, v_behavior text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.comment_stmt ( v_type text DEFAULT NULL, v_objtype text DEFAULT NULL, v_object jsonb DEFAULT NULL, v_comment text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.sec_label_stmt ( v_type text DEFAULT NULL, v_objtype text DEFAULT NULL, v_object jsonb DEFAULT NULL, v_provider text DEFAULT NULL, v_label text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.declare_cursor_stmt ( v_type text DEFAULT NULL, v_portalname text DEFAULT NULL, v_options int DEFAULT NULL, v_query jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.close_portal_stmt ( v_type text DEFAULT NULL, v_portalname text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.fetch_stmt ( v_type text DEFAULT NULL, v_direction text DEFAULT NULL, v_howmany bigint DEFAULT NULL, v_portalname text DEFAULT NULL, v_ismove boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_stats_stmt ( v_type text DEFAULT NULL, v_defnames jsonb DEFAULT NULL, v_stat_types jsonb DEFAULT NULL, v_exprs jsonb DEFAULT NULL, v_relations jsonb DEFAULT NULL, v_stxcomment text DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_stats_stmt ( v_type text DEFAULT NULL, v_defnames jsonb DEFAULT NULL, v_stxstattarget int DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_function_stmt ( v_type text DEFAULT NULL, v_is_procedure boolean DEFAULT NULL, v_replace boolean DEFAULT NULL, v_funcname jsonb DEFAULT NULL, v_parameters jsonb DEFAULT NULL, v_returntype jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.function_parameter ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_argtype jsonb DEFAULT NULL, v_mode text DEFAULT NULL, v_defexpr jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_function_stmt ( v_type text DEFAULT NULL, v_objtype text DEFAULT NULL, v_func jsonb DEFAULT NULL, v_actions jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.do_stmt ( v_type text DEFAULT NULL, v_args jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.inline_code_block ( v_type text DEFAULT NULL, v_source_text text DEFAULT NULL, v_langoid jsonb DEFAULT NULL, v_langistrusted boolean DEFAULT NULL, v_atomic boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.call_stmt ( v_type text DEFAULT NULL, v_funccall jsonb DEFAULT NULL, v_funcexpr jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.call_context ( v_type text DEFAULT NULL, v_atomic boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.rename_stmt ( v_type text DEFAULT NULL, v_renametype text DEFAULT NULL, v_relationtype text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_object jsonb DEFAULT NULL, v_subname text DEFAULT NULL, v_newname text DEFAULT NULL, v_behavior text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_object_depends_stmt ( v_type text DEFAULT NULL, v_objecttype text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_object jsonb DEFAULT NULL, v_extname jsonb DEFAULT NULL, v_remove boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_object_schema_stmt ( v_type text DEFAULT NULL, v_objecttype text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_object jsonb DEFAULT NULL, v_newschema text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_owner_stmt ( v_type text DEFAULT NULL, v_objecttype text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_object jsonb DEFAULT NULL, v_newowner jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_operator_stmt ( v_type text DEFAULT NULL, v_opername jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_type_stmt ( v_type text DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.rule_stmt ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_rulename text DEFAULT NULL, v_whereclause jsonb DEFAULT NULL, v_event text DEFAULT NULL, v_instead boolean DEFAULT NULL, v_actions jsonb DEFAULT NULL, v_replace boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.notify_stmt ( v_type text DEFAULT NULL, v_conditionname text DEFAULT NULL, v_payload text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.listen_stmt ( v_type text DEFAULT NULL, v_conditionname text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.unlisten_stmt ( v_type text DEFAULT NULL, v_conditionname text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.transaction_stmt ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_savepoint_name text DEFAULT NULL, v_gid text DEFAULT NULL, v_chain boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.composite_type_stmt ( v_type text DEFAULT NULL, v_typevar jsonb DEFAULT NULL, v_coldeflist jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_enum_stmt ( v_type text DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_vals jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_range_stmt ( v_type text DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_params jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_enum_stmt ( v_type text DEFAULT NULL, v_typename jsonb DEFAULT NULL, v_oldval text DEFAULT NULL, v_newval text DEFAULT NULL, v_newvalneighbor text DEFAULT NULL, v_newvalisafter boolean DEFAULT NULL, v_skipifnewvalexists boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.view_stmt ( v_type text DEFAULT NULL, v_view jsonb DEFAULT NULL, v_aliases jsonb DEFAULT NULL, v_query jsonb DEFAULT NULL, v_replace boolean DEFAULT NULL, v_options jsonb DEFAULT NULL, v_withcheckoption text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.load_stmt ( v_type text DEFAULT NULL, v_filename text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.createdb_stmt ( v_type text DEFAULT NULL, v_dbname text DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_database_stmt ( v_type text DEFAULT NULL, v_dbname text DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_database_set_stmt ( v_type text DEFAULT NULL, v_dbname text DEFAULT NULL, v_setstmt jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.dropdb_stmt ( v_type text DEFAULT NULL, v_dbname text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_system_stmt ( v_type text DEFAULT NULL, v_setstmt jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.cluster_stmt ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_indexname text DEFAULT NULL, v_options int DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.vacuum_stmt ( v_type text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_rels jsonb DEFAULT NULL, v_is_vacuumcmd boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.vacuum_relation ( v_type text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_oid jsonb DEFAULT NULL, v_va_cols jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.explain_stmt ( v_type text DEFAULT NULL, v_query jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_table_as_stmt ( v_type text DEFAULT NULL, v_query jsonb DEFAULT NULL, v_into jsonb DEFAULT NULL, v_relkind text DEFAULT NULL, v_is_select_into boolean DEFAULT NULL, v_if_not_exists boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.refresh_mat_view_stmt ( v_type text DEFAULT NULL, v_concurrent boolean DEFAULT NULL, v_skipdata boolean DEFAULT NULL, v_relation jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.check_point_stmt ( v_type text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.discard_stmt ( v_type text DEFAULT NULL, v_target text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.lock_stmt ( v_type text DEFAULT NULL, v_relations jsonb DEFAULT NULL, v_mode int DEFAULT NULL, v_nowait boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.constraints_set_stmt ( v_type text DEFAULT NULL, v_constraints jsonb DEFAULT NULL, v_deferred boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.reindex_stmt ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_relation jsonb DEFAULT NULL, v_name text DEFAULT NULL, v_options int DEFAULT NULL, v_concurrent boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_conversion_stmt ( v_type text DEFAULT NULL, v_conversion_name jsonb DEFAULT NULL, v_for_encoding_name text DEFAULT NULL, v_to_encoding_name text DEFAULT NULL, v_func_name jsonb DEFAULT NULL, v_def boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_cast_stmt ( v_type text DEFAULT NULL, v_sourcetype jsonb DEFAULT NULL, v_targettype jsonb DEFAULT NULL, v_func jsonb DEFAULT NULL, v_context text DEFAULT NULL, v_inout boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_transform_stmt ( v_type text DEFAULT NULL, v_replace boolean DEFAULT NULL, v_type_name jsonb DEFAULT NULL, v_lang text DEFAULT NULL, v_fromsql jsonb DEFAULT NULL, v_tosql jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.prepare_stmt ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_argtypes jsonb DEFAULT NULL, v_query jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.execute_stmt ( v_type text DEFAULT NULL, v_name text DEFAULT NULL, v_params jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.deallocate_stmt ( v_type text DEFAULT NULL, v_name text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.drop_owned_stmt ( v_type text DEFAULT NULL, v_roles jsonb DEFAULT NULL, v_behavior text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.reassign_owned_stmt ( v_type text DEFAULT NULL, v_roles jsonb DEFAULT NULL, v_newrole jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_ts_dictionary_stmt ( v_type text DEFAULT NULL, v_dictname jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_ts_configuration_stmt ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_cfgname jsonb DEFAULT NULL, v_tokentype jsonb DEFAULT NULL, v_dicts jsonb DEFAULT NULL, v_override boolean DEFAULT NULL, v_replace boolean DEFAULT NULL, v_missing_ok boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_publication_stmt ( v_type text DEFAULT NULL, v_pubname text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_tables jsonb DEFAULT NULL, v_for_all_tables boolean DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_publication_stmt ( v_type text DEFAULT NULL, v_pubname text DEFAULT NULL, v_options jsonb DEFAULT NULL, v_tables jsonb DEFAULT NULL, v_for_all_tables boolean DEFAULT NULL, v_tableaction text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.create_subscription_stmt ( v_type text DEFAULT NULL, v_subname text DEFAULT NULL, v_conninfo text DEFAULT NULL, v_publication jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.alter_subscription_stmt ( v_type text DEFAULT NULL, v_kind text DEFAULT NULL, v_subname text DEFAULT NULL, v_conninfo text DEFAULT NULL, v_publication jsonb DEFAULT NULL, v_options jsonb DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast.drop_subscription_stmt ( v_type text DEFAULT NULL, v_subname text DEFAULT NULL, v_missing_ok boolean DEFAULT NULL, v_behavior text DEFAULT NULL ) RETURNS jsonb AS $EOFCODE$
DECLARE
...
CREATE FUNCTION ast_helpers.cpt_own_records ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
...
CREATE FUNCTION ast_helpers.cpt_owned_records ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
  -- Function(id), Field(id)
...
CREATE FUNCTION ast_helpers.cpt_multi_owners ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
  key_asts jsonb[];
  item jsonb;
...
CREATE FUNCTION ast_helpers.cpt_permission_name ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
...
CREATE FUNCTION ast_helpers.cpt_owned_object_records ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
...
CREATE FUNCTION ast_helpers.cpt_administrator_records ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
...
CREATE FUNCTION ast_helpers.cpt_child_of_owned_object_records ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
...
CREATE FUNCTION ast_helpers.cpt_child_of_owned_object_records_group_array ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
...
CREATE FUNCTION ast_helpers.cpt_child_of_owned_object_records_with_ownership ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
...
CREATE FUNCTION ast_helpers.cpt_owned_object_records_group_array ( policy_template_vars jsonb ) RETURNS jsonb AS $EOFCODE$
DECLARE
  policy_ast jsonb;
BEGIN
