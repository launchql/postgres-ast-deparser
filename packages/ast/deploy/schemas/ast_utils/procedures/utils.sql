...
-- ) returns int as $$
-- 	select (CASE
--     WHEN (typ ='RESERV') THEN 0
--     WHEN (typ ='MONTH') THEN 1
--     WHEN (typ ='YEAR') THEN 2
--     WHEN (typ ='DAY') THEN 3
--     WHEN (typ ='JULIAN') THEN 4
--     WHEN (typ ='TZ') THEN 5
--     WHEN (typ ='DTZ') THEN 6
--     WHEN (typ ='DYNTZ') THEN 7
--     WHEN (typ ='IGNORE_DTF') THEN 8
--     WHEN (typ ='AMPM') THEN 9
--     WHEN (typ ='HOUR') THEN 10
--     WHEN (typ ='MINUTE') THEN 11
--     WHEN (typ ='SECOND') THEN 12
--     WHEN (typ ='MILLISECOND') THEN 13
--     WHEN (typ ='MICROSECOND') THEN 14
--     WHEN (typ ='DOY') THEN 15
--     WHEN (typ ='DOW') THEN 16
--     WHEN (typ ='UNITS') THEN 17
--     WHEN (typ ='ADBC') THEN 18
--     WHEN (typ ='AGO') THEN 19
--     WHEN (typ ='ABS_BEFORE') THEN 20
--     WHEN (typ ='ABS_AFTER') THEN 21
--     WHEN (typ ='ISODATE') THEN 22
--     WHEN (typ ='ISOTIME') THEN 23
--     WHEN (typ ='WEEK') THEN 24
--     WHEN (typ ='DECADE') THEN 25
--     WHEN (typ ='CENTURY') THEN 26
--     WHEN (typ ='MILLENNIUM') THEN 27
...
-- ) returns text as $$
-- 	select (CASE
-- WHEN (typ = 0) THEN 'RESERV'
--     WHEN (typ = 1) THEN 'MONTH'
--     WHEN (typ = 2) THEN 'YEAR'
--     WHEN (typ = 3) THEN 'DAY'
--     WHEN (typ = 4) THEN 'JULIAN'
--     WHEN (typ = 5) THEN 'TZ'
--     WHEN (typ = 6) THEN 'DTZ'
--     WHEN (typ = 7) THEN 'DYNTZ'
--     WHEN (typ = 8) THEN 'IGNORE_DTF'
--     WHEN (typ = 9) THEN 'AMPM'
--     WHEN (typ = 10) THEN 'HOUR'
--     WHEN (typ = 11) THEN 'MINUTE'
--     WHEN (typ = 12) THEN 'SECOND'
--     WHEN (typ = 13) THEN 'MILLISECOND'
--     WHEN (typ = 14) THEN 'MICROSECOND'
--     WHEN (typ = 15) THEN 'DOY'
--     WHEN (typ = 16) THEN 'DOW'
--     WHEN (typ = 17) THEN 'UNITS'
--     WHEN (typ = 18) THEN 'ADBC'
--     WHEN (typ = 19) THEN 'AGO'
--     WHEN (typ = 20) THEN 'ABS_BEFORE'
--     WHEN (typ = 21) THEN 'ABS_AFTER'
--     WHEN (typ = 22) THEN 'ISODATE'
--     WHEN (typ = 23) THEN 'ISOTIME'
--     WHEN (typ = 24) THEN 'WEEK'
--     WHEN (typ = 25) THEN 'DECADE'
--     WHEN (typ = 26) THEN 'CENTURY'
--     WHEN (typ = 27) THEN 'MILLENNIUM'
